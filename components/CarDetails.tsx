...
import { Dialog,Transition,DialogPanel,DialogTitle, Button,TransitionChild } from '@headlessui/react';
    ...
    <>
        <Transition appear show={isOpen}>
          <Dialog open={isOpen} as="div" className="relative z-10"  onClose={closeModal}>
            ...
            leaveTo='opacity-0'
            >
                <div className="fixed inset-0 z-9 bg-black bg-opacity-25"></div>
            </TransitionChild>
            <div className='fixed inset-0 overflow-y-auto'>
                <div className='flex min-h-full items-center justify-center p-4 text-center'>
                    ...
                    >
                        <DialogPanel className=" relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white shadow-xl transition p-6 flex flex-col gap-5 ">
